...
const ResidentialQuotation = (props: any) => {
  ...
  const resetForm = () => {
    setFormData({
      ...
      numberOfPanels: 0,
      solarInverter: "",
      moduleMountingStructureMake:
        "Apollo 2.0 MM structure (Hot Deep GI 80 Micron)",
      moduleMountingStructureDescription: "As Per Site Condition",
      moduleMountingStructureQuantity: "As Per Site",
      location: "",
      agentID: "",
  ...
  const validateAndCalculate = () => {
    ...
    if (
      formData["numberOfPanels"] < 4 ||
      formData["numberOfPanels"] == 7 ||
      formData["numberOfPanels"] == 12 ||
    ...
    if (!formData["moduleMountingStructureDescription"]) {
      errorMessage_.push(
        "Module mounting structure description cannot be empty."
      );
    }
  ...
  useEffect(() => {
    handleFormChange(
      "totalKiloWatts",
      (formData["numberOfPanels"] * formData["solarModuleWattage"]) / 1000
    );
  ...
  useEffect(() => {
    ...
    formData["solarModule"],
    formData["solarModuleType"],
    formData["solarModuleWattage"],
    formData["totalKiloWatts"],
    formData["numberOfPanels"],
    formData["solarInverter"],
    formData["moduleMountingStructureMake"],
    formData["moduleMountingStructureDescription"],
    formData["moduleMountingStructureQuantity"],
    formData["location"],
    formData["agentID"],
    formData["agentName"],
    formData["customerName"],
  ...
  useEffect(() => {
    if (formData["solarModuleType"] === "Poly") {
      ...
      formData["solarModuleType"] === "Mono Perc" ||
      formData["solarModuleType"] === "Mono Perc Bifacial" ||
      formData["solarModuleType"] === "Topcon"
    ) {
                ...
                <Table aria-label="simple table">
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell>{formData["agentName"]}</TableCell>
                    </TableRow>
                    <TableRow>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell>
                        ...
                        <br />
                        <Select
                          value={formData["solarModuleType"]}
                          onChange={(e) =>
                      ...
                      <TableCell>{formData["solarModuleWattage"]}</TableCell>
                      <TableCell>
                        <TextField
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <TextField
                          ...
                          onChange={(e) =>
                            handleFormChange(
                              "moduleMountingStructureDescription",
                              e.target.value
                            )
                          }
                        />
                      ...
                      <TableCell>
                        <TextField
                          ...
                          onChange={(e) =>
                            handleFormChange(
                              "moduleMountingStructureQuantity",
                              e.target.value
                            )
                          }
                        />
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        IP 65 enclosure (As per Standard Industry require)
                      </TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        As per Standard Unbreakable-KEI 16xmm
                      </TableCell>
                      <TableCell>KEI</TableCell>
                      <TableCell>As Per Site</TableCell>
                    </TableRow>
                    <TableRow>
                      ...
                      <TableCell>
                        Proper Chemical earth thing as per Standard with full
                        Protection with LA
                      </TableCell>
                      <TableCell>Standard</TableCell>
                      <TableCell>3</TableCell>
                ...
                <Table border={2}>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell>1</TableCell>
                      <TableCell>
                        GUVNL RATE PER KW FOR DESIGN, SUPPLY, INSTALLATION &amp;
                        COMMISIONING OF SOLAR ROOFTOP SYSTEM
                      </TableCell>
                      <TableCell width="1%">
                        {formData["totalKiloWatts"]} kW
                      </TableCell>
                      <TableCell>
                        <TextField
                          ...
                          onChange={(e) =>
                            handleFormChange("structure", e.target.value)
                          }
                        />
                        <br />
                        <Button
                          variant="contained"
                          onClick={() => handleFormChange("structure", "2//6")}
                        >
                          2//6
                        </Button>
                        &nbsp;
                        <Button
                          variant="contained"
                          onClick={() => handleFormChange("structure", "4//8")}
                        >
                          4//8
                        </Button>
                        &nbsp;
                        <Button
                          variant="contained"
                          onClick={() => handleFormChange("structure", "6//10")}
                        >
                          6//10
                        </Button>
                      </TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        ₹{formData["calculatedSubsidy"].toLocaleString("en-IN")}
                      </TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell colSpan={3}>
                        ...
                        {(
                          ...
                          formData["calculatedSubsidy"]
                        ).toLocaleString("en-IN")}
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell colSpan={2}>
                        {formData["structure"]} FT ELEVATED STRUCTURE
                      </TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell colSpan={3}>
                        ...
                        <RadioGroup
                          ...
                          onChange={(e) =>
                            handleFormChange("discomOrTorrent", e.target.value)
                          }
                        ...
                        <>
                          ...
                          <RadioGroup
                            ...
                            name="row-radio-buttons-group"
                            onChange={(e) =>
                              handleFormChange("phase", e.target.value)
                            }
                    ...
                    <TableRow>
                      <TableCell colSpan={2}>
                        Installation AC MCB Switch charges
                      </TableCell>
                      <TableCell colSpan={3}>
                        <Select
                          value={formData["installmentAcMcbSwitchCharge"]}
                          onChange={(e) =>
                            handleFormChange(
                              "installmentAcMcbSwitchCharge",
                              parseInt((e.target as HTMLInputElement).value)
                            )
                          }
                        >
                    ...
                    <TableRow>
                      ...
                      <TableCell colSpan={3}>
                        <Select
                          value={formData["gebAgreementFees"]}
                          onChange={(e) =>
                            handleFormChange(
                              "gebAgreementFees",
                              parseInt((e.target as HTMLInputElement).value)
