...
const CommercialOrIndustrialQuotation = (props: any) => {
  ...
  const solarModuleTypeOptions = [
    ...
    {
      value: "Mono Perc Bifacial",
      text: "Mono Perc Bifacial",
      area: 2.54,
      pr_ratio: 0.9,
      efficiency: 0.23,
    },
  ...
  const handleCalculationDataChange = (e: React.BaseSyntheticEvent) => {
    if (
      e.target.name != "isLoan" &&
      e.target.name != "isSubsidy" &&
      e.target.name != "isMeterChargesSelfPaid"
    ) {
  ...
  useEffect(() => {
    if (formData["city"]) {
      console.log(
        "latitude",
        locationOptions[formData["location"]][formData["city"]]["latitude"],
        "longitude",
        locationOptions[formData["location"]][formData["city"]]["longitude"]
      );
      handleFormChange(
        "latitude",
        locationOptions[formData["location"]][formData["city"]]["latitude"]
                      ...
                      <TableCell colSpan={3}>
                        <FormControl sx={{ m: 1, minWidth: 220 }}>
                          ...
                          <Select
                            ...
                            onChange={(e) => handleQuotationTypeSelect(e)}
                          >
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <TextField
                          ...
                          value={formData["solarModuleWattage"]}
                          type="text"
                          name="solarModuleWattage"
                          placeholder="Solar Module Wattage"
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <TextField
                          ...
                          placeholder="Enter capacity of Inverter"
                          onChange={(e: React.BaseSyntheticEvent) => {
                            e.target.value = isNaN(e.target.valueAsNumber)
                              ? 0
                              : e.target.valueAsNumber;
                    ...
                    <TableRow>
                      ...
                      <TableCell colSpan={2}>
                        <FormControl sx={{ m: 1, minWidth: 220 }}>
                          ...
                          <Select
                            label="switchGearAndProtection"
                            value={formData["switchGearAndProtection"]}
                            onChange={(e) =>
                              handleFormChange(
                                "switchGearAndProtection",
                                e.target.value
                ...
                <Table border={2}>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        10 year manufacturing fault guarantee <br /> 25 year
                ...
                <Table border={2}>
                  <TableHead>
                    <TableRow>
                      <TableCell colSpan={4} align="center">
                        Calculations{" "}
                        {formData["totalKiloWatts"] > 0 && (
                          <span>
                            for {formData["totalKiloWatts"]} KiloWatts
                          </span>
                        )}
                      </TableCell>
                    </TableRow>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell>₹15340.00/-</TableCell>
                      <TableCell>Stamp charges</TableCell>
                      <TableCell>₹660.00/-</TableCell>
                    </TableRow>
                    <TableRow>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <TextField
                          value={calculationData["ratePerWatt"]}
                          type="number"
                          name="ratePerWatt"
                          onChange={handleCalculationDataChange}
                        />
                      ...
                      <TableCell>
                        <TextField
                          value={calculationData["gstPerWatt"]}
                          type="number"
                          name="gstPerWatt"
                          onChange={handleCalculationDataChange}
                        />
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <TextField
                          value={calculationData["electricityUnitRate"]}
                          type="number"
                      ...
                      <TableCell>
                        <TextField
                          value={calculationData["inflationInUnitRate"]}
                          type="number"
                          name="inflationInUnitRate"
                          onChange={handleCalculationDataChange}
                        />
                      </TableCell>
                    </TableRow>
                    ...
                    {calculationData["isLoan"] && (
                      <>
                        <TableRow>
                          <TableCell>Loan amount on project </TableCell>
                          <TableCell>
                            <TextField
                              value={calculationData["loanAmountOnProject"]}
                              type="number"
                              name="loanAmountOnProject"
                              onChange={handleCalculationDataChange}
                            />
                          </TableCell>
                        ...
                        <TableRow>
                          ...
                          <TableCell>
                            <TextField
                              value={calculationData["interestRateOnLoan"]}
                              type="number"
                              name="interestRateOnLoan"
                              onChange={handleCalculationDataChange}
                            />
                          </TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <TextField
                          value={calculationData["reinvestmentRate"]}
                          type="number"
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        <TextField
                          value={calculationData["anyExtraCostOnAddOnWork"]}
                          type="number"
                          name="anyExtraCostOnAddOnWork"
                          onChange={handleCalculationDataChange}
                        />
                      </TableCell>
                      ...
                      <TableCell>
                        <TextField
                          value={calculationData["gstOnAddOnWork"]}
                          type="number"
                          name="gstOnAddOnWork"
                          onChange={handleCalculationDataChange}
                        />
                    ...
                    <TableRow>
                      <TableCell>
                        Final cost of project incl. add-on work
                      </TableCell>
                      <TableCell colSpan={3}>
                    ...
                    {formData["quotationType"] == "Industrial" && (
                      <TableRow>
                      ...
                      formData["quotationType"] == "Industrial" && (
                        <>
                          <TableRow>
                            ...
                            <TableCell>
                              <TextField
                                value={calculationData["subsidyPerWatt"]}
                                type="number"
                                name="subsidyPerWatt"
                                onChange={handleCalculationDataChange}
                              />
                          ...
                          <TableRow>
                            <TableCell>
                              Total value of project after subsidy
                            </TableCell>
                            <TableCell colSpan={3}>
                              {(isNaN(
                                Math.round(
