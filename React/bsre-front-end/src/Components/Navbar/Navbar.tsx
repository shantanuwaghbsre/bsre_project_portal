...
export default function Navbar(props: any) {
    ...
    const drawer = (
        <div>
            <Toolbar >
                <img src="/Images/BS-LOGO.jpg" alt="logo" width={40} height={40} style={{ position: 'absolute', left: '5%', marginTop: '0%' }} />
                <span style={{ position: 'absolute', left: '30%', fontSize: '12px', marginTop: '-5%' }}>Bapa Sitaram</span>
                <span style={{ position: 'absolute', left: '30%', fontSize: '12px', marginTop: '5%' }}>Solar System</span>
            </Toolbar>
            <Divider />
            <List>
                ...
                <Collapse in={isCollapseQuotation} timeout="auto" unmountOnExit>
                    <List>
                        <ListItem disablePadding onClick={() => handleNavigation("/ViewQuotations")}>
                            <ListItemButton>
                                <ListItemIcon>
                        ...
                        <ListItem disablePadding onClick={() => handleNavigation("/ResidentialQuotation")}>
                            <ListItemButton>
                                <ListItemIcon>
                                    <FormatQuoteIcon fontSize='small' />
                                </ListItemIcon>
                        ...
                        <ListItem disablePadding onClick={() => handleNavigation("/CommercialOrIndustrialQuotation")}>
                            <ListItemButton>
                                <ListItemIcon>
                                    <FormatQuoteIcon fontSize='small' />
                                </ListItemIcon>
                ...
                <Collapse in={isCollapseAgent} timeout="auto" unmountOnExit>
                    <List>
                        <ListItem disablePadding onClick={() => handleNavigation("/ViewAllAgents")}>
                            <ListItemButton>
                                <ListItemIcon>
                        ...
                        <ListItem disablePadding onClick={() => handleNavigation("/AddAgent")}>
                            <ListItemButton>
                                <ListItemIcon>
                                    <SupportAgentIcon fontSize='small' />
                                </ListItemIcon>
                ...
                <Collapse in={isCollapseConsumer} timeout="auto" unmountOnExit>
                    <List>
                        <ListItem disablePadding onClick={() => handleNavigation("/ViewAllConsumers")}>
                            <ListItemButton>
                                <ListItemIcon>
                        ...
                        <ListItem disablePadding onClick={() => handleNavigation("/ConsumerOnboarding")}>
                            <ListItemButton>
                                <ListItemIcon>
                                    <PersonIcon fontSize='small' />
                                </ListItemIcon>
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                <Toolbar>
                    ...
                    <Typography style={{ flexGrow: 1, display: 'flex', justifyContent: 'end' }} variant="h6" noWrap component="div">
                        <Tooltip title="Account settings">
                            ...
                            >
                                <Avatar sx={{ width: 32, height: 32, bgcolor: deepOrange[500] }}>{stringAvatar('Adarsh ')}</Avatar>
                            </IconButton>
                        </Tooltip>
                        <Menu
                            anchorEl={anchorEl}
